...
class DesignationController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        $data = Designation::getDepList($page_size, $page, $sorted, $filtered);
    ...
    public function store(Request $request)
    {
        ...
        if ($id) {
            ...
            $data = Designation::where('id', $id)->where('orgid', $this->orgid)->first();
            ...
            save_log('designation', 'id', $id, $input, 'Update');
            ...
            if ($data = Designation::forceCreate($input)) {
    ...
    public function destroy(Request $request)
    {
        ...
        $id = $request->get('id');
        save_log('designation', 'id', $id, false, 'Delete');
        $data = Designation::where('id', $id)->where('orgid', $this->orgid)->delete();
        if ($data) {
