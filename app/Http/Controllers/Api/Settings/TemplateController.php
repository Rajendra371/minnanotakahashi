...
class TemplateController extends Controller
{
    ...
    public function index()
    {
        ...
        $data = Template::get()->where('orgid',$orgid);
        if($data)
        {
    ...
    public function store(Request $request)
    {
       ...
       if ($validator->fails()) {
        ...
        $input['modifyby']=$createdby;
        save_log('Template','id',$id,$input,'Update');
        ...
        $input['orgid']=$orgid;
          ...
          if($data=Template:: forceCreate($input)){
    ...
    public function destroy(Request $request)
    {
        ...
        $id=$request->get('id');
          save_log('Template','id',$id,false,'Delete');
        $data=Template::where('id', $id)->delete();
        if($data)
        {
    ...
    public function getTableData(Request $request){
        ...
        $data = Template::getTableData($page_size, $page, $sorted, $filtered);
