...
(function(navigator, window, document, $) {
    ...
    Trumbowyg.prototype = {
        ...
        addBtnDef: function(btnName, btnDef) {
            this.btnsDef[btnName] = $.extend(
                btnDef,
                this.btnsDef[btnName] || {}
            );
        },
            ...
            t.$ed
                ...
                .on("keydown", function(e) {
                    ...
                    if ((e.ctrlKey || e.metaKey) && !e.altKey) {
                        ctrl = true;
                        var key =
                            t.keys[String.fromCharCode(e.which).toUpperCase()];
                ...
                .on("keyup compositionend", function(e) {
                    ...
                    if (
                        (e.ctrlKey || e.metaKey) &&
                        (keyCode === 89 || keyCode === 90)
                    ) {
                        t.semanticCode(false, true);
                        t.$c.trigger("tbwchange");
                    } else if (!ctrl && keyCode !== 17) {
                        var compositionEndIE = t.isIE
                            ? e.type === "compositionend"
                            : true;
                        t.semanticCode(
                            false,
                            compositionEndIE && keyCode === 13
                        );
                        t.$c.trigger("tbwchange");
        ...
        semanticTag: function(oldTag, copyAttributes, revert) {
            ...
            if (
                this.o.semantic != null &&
                typeof this.o.semantic === "object" &&
                this.o.semantic.hasOwnProperty(oldTag)
            ) {
                newTag = this.o.semantic[oldTag];
            } else if (
                this.o.semantic === true &&
        ...
        addErrorOnModalField: function($field, err) {
            ...
            $row.addClass(prefix + "input-error")
