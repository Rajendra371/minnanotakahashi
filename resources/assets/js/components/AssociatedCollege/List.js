        ...
        <div className="animated fadeIn">
          <Row>
            <Col>
              <Card>
                <CardHeader>
                  <CardTitle>Associated College List</CardTitle>
...
function load_table_data() {
  var dataurl = constvar.api_url + "associated_college/list";
  var message = "";
  message = "<p class='text-danger'>No Record Found!! </p>";
  var dtablelist = $("#associatedCollegeList")
    .dataTable({
