...
export default class List extends Component {
    ...
    getListData(page, pageSize, sorted, filtered, handleRetrievedData) {
        let url = constvar.api_url + "software/getTableData";
        let postObject = {
            page: page,
            pageSize: pageSize,
            sorted: sorted,
                ...
                <div className="animated fadeIn">
                    <Row>
                        <Col>
                            <Card>
                                <CardHeader>
                                    <CardTitle><FormattedMessage id="software.list" /></CardTitle>
                                ...
                                <CardBody>
                                    <ReactTable
                                        ...
                                        columns={[
                                            {
                                                Header:<FormattedMessage id="software.name" />,
                                                accessor: "softwarename"
                                            },
                                            {
                                                Header: <FormattedMessage id="software.type" />,
                                                accessor: "softwaretype"
                                            },
                                            {
                                                Header: <FormattedMessage id="software.version" />,
