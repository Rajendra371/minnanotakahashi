...
export default class List extends Component {
  ...
  refreshTable(e) {
    let url = constvar.api_url + "employee_type_setup/getTableData";
    let postObject = {
      page: 0,
      pageSize: 10,
      sorted: [],
                        ...
                        Cell: (row) => (
                          <div>
                            <a
                              ...
                              className="btnEdit"
                              data-url={constvar.api_url + "employee_type_setup/edit"}
                              data-id={row.value}
                              data-targetform="employeeTypeForm"
                            >
                            ...
                            <a
                              ...
                              className="btnDelete"
                              data-url={
                                constvar.api_url + "employee_type_setup/delete"
                              }
                              data-id={row.value}
                            >
