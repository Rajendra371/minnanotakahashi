          ...
          <div className="animated fadeIn">
              <Row>
                  <Col>
                      <Card>
                          <CardHeader>
                              <CardTitle>Cron Setup List</CardTitle>
            ...
            <div className="col-md-3 align-self-end">
                          ...
                          <table id="myTable" className="table table-striped">
                              <thead>
                                  <tr>
                                      <th width="5%">S.No.</th>
                                      <th width="10%">Cron Title</th>
                                      <th width="10%">Cron Code</th>
                                      <th width="10%">Cron URL</th>
...
function load_table_data() {
    ...
    var dataurl = constvar.api_url + "cron/cron_list";
    var message = "";
    ...
    var dtablelist = $("#myTable")
        .dataTable({
            ...
            fnServerParams: function (aoData) {
                ...
                aoData.push({ name: "Cron_Name", value: Cron_Name });
