                      ...
                      <Card>
                          ...
                          <table id="myTable" className="table table-striped">
                              <thead>
                                  <tr>
                                      <th width="5%">S.No.</th>
                                      <th width="10%">Facebook App</th>
                                      <th width="10%">Google App </th>
                                      <th width="10%">Google Analytics</th>
                                      <th width="10%">LinkedIn App Login</th>
...
function load_table_data() {
    ...
    var dataurl = constvar.api_url + "socialmediaintegration/socialmedia_list";
    var message = "";
