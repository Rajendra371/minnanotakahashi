                                ...
                                <ul>
                                    @if (!empty($nbranch->contact_person))
                                        <li>
                                            ...
                                            <span>{{ !empty($nbranch->contact_person) ? $nbranch->contact_person : '' }}</span>
                                        </li>
                                    @endif
                                    @if (!empty($nbranch->branch_location))
                                        <li>
                                            <i class="fa fa-map-marker"></i>
                                            <span>{{ !empty($nbranch->branch_location) ? $nbranch->branch_location : '' }}</span>
                                        </li>
                                    @endif
                                    @if (!empty($nbranch->contact_number))
                                        <li>
                                            <i class="fa fa-phone"></i>
                                            <span>{{ !empty($nbranch->contact_number) ? $nbranch->contact_number : '' }}</span>
                                        </li>
                                    @endif
                                    @if (!empty($nbranch->email))
                                        <li>
                                            <i class="fa fa-envelope"></i>
                                            <span>{{ !empty($nbranch->email) ? $nbranch->email : '' }}</span>
                                        </li>
                                    @endif
                                </ul>
                            </div>
                            ...
                            <div class="b_box">
                                ...
                                <ul>
                                    @if (!empty($inbranch->contact_person))
                                        <li>
                                            <i class="fa fa-user"></i>
                                            <span>{{ !empty($inbranch->contact_person) ? $inbranch->contact_person : '' }}</span>
                                        </li>
                                    @endif
                                    @if (!empty($inbranch->branch_location))
                                        <li>
                                            <i class="fa fa-map-marker"></i>
                                            <span>{{ !empty($inbranch->branch_location) ? $inbranch->branch_location : '' }}</span>
                                        </li>
                                    @endif
                                    @if (!empty($inbranch->contact_number))
                                        <li>
                                            <i class="fa fa-phone"></i>
                                            <span>{{ !empty($inbranch->contact_number) ? $inbranch->contact_number : '' }}</span>
                                        </li>
                                    @endif
                                    @if (!empty($inbranch->email))
                                        <li>
                                            <i class="fa fa-envelope"></i>
                                            <span>{{ !empty($inbranch->email) ? $inbranch->email : '' }}</span>
                                        </li>
                                    @endif
                                </ul>
                            </div>
