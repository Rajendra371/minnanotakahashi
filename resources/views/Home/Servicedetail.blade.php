		...
		<div class="row">
			<div class="col-12">
				<div class="bread-inner">
					...
					<!-- Bread Title -->
					<div class="bread-title"><h2>Service Details</h2></div>
				</div>
			</div>
		</div>
	</div>
...
<!-- Service Single -->
@if (!empty($service_details) && count($service_details))
<section class="service-single section-space">
	<div class="container">
		<div class="row">
			<div class="col-lg-8 col-12">
				<div class="service-main-box">
					<h3>{{$service_details[0]->service_name}}</h3>
					{{-- <h5>
						Community Nursing support you can count on.
					</h5> --}}
					<p>
						{{$service_details[0]->short_content}}
					</p>
				</div>
				<!-- Service Image -->
				<div class="service-img">
					<figure><img src="{{ asset('uploads/service_image/'.$service_details[0]->image) }}" alt="{{$service_details[0]->service_name}}"></figure>
				</div>
				<!-- Service Content -->
				<div class="service-content">
					{!! $service_details[0]->content !!}
				</div>
			</div>
