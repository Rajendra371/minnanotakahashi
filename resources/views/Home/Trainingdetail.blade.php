		...
		<div class="row">
			<div class="col-12">
				<div class="bread-inner">
					...
					<!-- Bread Title -->
					<div class="bread-title"><h2>Training Details</h2></div>
				</div>
			</div>
		</div>
	</div>
...
<!-- Service Single -->
@if (!empty($training_details) && count($training_details))
<section class="service-single section-space">
	<div class="container">
		<div class="row">
			<div class="col-lg-8 col-12">
				<div class="service-main-box">
					<h3>{{$training_details[0]->title}}</h3>
					{{-- <h5>
						Community Nursing support you can count on.
					</h5> --}}
					<p>
						{{$training_details[0]->short_description}}
					</p>
				</div>
				<!-- Service Image -->
				<div class="service-img">
					<figure><img src="{{ asset('uploads/training_image/'.$training_details[0]->training_image) }}" alt="{{$training_details[0]->title}}"></figure>
				</div>
				<!-- Service Content -->
				<div class="service-content">
					{!! $training_details[0]->description !!}
