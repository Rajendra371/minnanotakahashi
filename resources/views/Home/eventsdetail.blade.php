		...
		<div class="row">
			<div class="col-12">
				<div class="bread-inner">
					...
					<!-- Bread Title -->
					<div class="bread-title"><h2>Events Details</h2></div>
				</div>
			</div>
		</div>
	</div>
...
<!-- Service Single -->
@if (!empty($events_detail) && count($events_detail))
<section class="service-single section-space">
	<div class="container">
		<div class="row">
			<div class="col-lg-8 col-12">
				<div class="service-main-box">
					<h3>{{$events_detail[0]->title}}</h3>
					{{-- <h5>
						Community Nursing support you can count on.
					</h5> --}}
					<p>
						{{$events_detail[0]->short_content}}
					</p>
				</div>
				<!-- Service Image -->
				<div class="service-img">
					<figure><img src="{{ asset('uploads/nne_image/'.$events_detail[0]->image) }}" alt="{{$events_detail[0]->title}}"></figure>
				</div>
				<!-- Service Content -->
				<div class="service-content">
					{!! $events_detail[0]->description !!}
