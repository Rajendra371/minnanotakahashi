                ...
                <div class="row">
                    <div class="col-12">
                        <div class="bread-inner">
                            ...
                            <div class="bread-title"><h2>Message from Chairman</h2></div>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="message-inner">                            
                            <div class="row">
                                <div class="col-xl-3 col-lg-4 col-md-12 col-sm-12">
                                    @if(!empty($cmmessage[0]->image))
                                    <figure>
                                        <img src="{{ asset('uploads/testimonial_image/' . $cmmessage[0]->image) }}"
                                            alt="{{!empty($cmmessage[0]->name)?$cmmessage[0]->name:''}}">
                                    </figure>
                                    @endif
                                </div>
                                <div class="col-xl-9 col-lg-8 col-md-12 col-sm-12">
                                    @if(!empty($cmmessage[0]->description))
